  ...
  return (
    <>
      ...
      >
        ...
        <div className="hidden md:flex bg-black text-gray-400 text-sm justify-between items-center px-8 py-2">
          {/* Social Icons */}
        ...
        <div className="bg-white shadow-md px-4 md:px-8 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6 text-[14px] font-semibold ml-auto">
            ...
            <a href="#" className="text-black hover:text-teal-400">MY ACCOUNT</a>
        ...
        {/* Mobile Navigation Menu (Only visible when menu button is clicked) */}
        {menuOpen && (
