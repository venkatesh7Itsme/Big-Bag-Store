    ...
    <div>
      <div className="bg-gray-100 py-16 text-left">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">BLOG LEFT SIDEBAR</h1>
          <div className="text-gray-600">
            <span>HOME</span> / <span className="text-teal-500">BLOG LEFT SIDEBAR</span>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row">
          {/* Left Sidebar */}
          <div className="w-full md:w-1/4 md:pr-8 order-first md:order-first">
            {/* Search */}
